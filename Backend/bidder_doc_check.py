...
def process_pdf_and_check_correctness(pdf_path):
    ...
    page = doc.load_page(0)
    pix = page.get_pixmap()
    # output_image_path = r"C:\Users\progg\Desktop\desktop_p\DocuDeck\MachineLearning\Bidder_Docs\OutputImg"
    # output_image_path = os.path.join(output_image_path, "out2.png")
    output_image_path = 'output.png'
    pix.save(output_image_path)
    doc.close()
